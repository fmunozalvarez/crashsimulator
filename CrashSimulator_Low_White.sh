...
echo
echo
echo  -e "\e[30mCrashSimulator - Oracle on Linux Crash Scenario Generator V1.04 Terms and Conditions"
echo  -e "\e[30m------------------------------------------------------------------------------------------"
echo  -e "\e[30mBy Francisco Munoz Alvarez - http://oraclenz.com"
echo  -e "\e[30mFollow me on Twitter [FCOMUNOZ] or Linkedin for news about updates, tips and tricks using CrashSimulator"
echo 
echo
...
echo 
echo 
echo -e "\e[30m\tCrashSimulator - Oracle on Linux Crash Scenario Generator V1.04"
echo -e "\e[30m\t-----------------------------------------------------------------"
echo -e "\e[30m\tBy Francisco Munoz Alvarez - http://oraclenz.com"
echo -e "\e[30m\tFollow me on Twitter [FCOMUNOZ] or Linkedin for news about updates, tips and tricks using CrashSimulator"
echo
echo -e "\e[30m\t\tChoose one of the following scenarios:"
echo 
echo -e "\e[31m\t\tNote: If not using a CDB environment please only execute the CDB and ASM scenarios:"
echo 
echo -e "\e[30m\t\t\tCDB  scenarios:\t\t\t\t\t" 
echo -e "\e[30m\t\t\t---------------\t\t\t\t\t"
echo 
echo -e "\e[31m\t\t\tLoss of a control file:-------------------------------->[ 1]" 
echo -e "\e[30m\t\t\tLoss of all control files:----------------------------->[ 2]"
echo -e "\e[31m\t\t\tLoss of a redo log file group member:------------------>[ 3]"
echo -e "\e[30m\t\t\tLoss of a redo log file group:------------------------->[ 4]"
echo -e "\e[31m\t\t\tLoss of a non-system datafile:------------------------->[ 5]"
echo -e "\e[30m\t\t\tLoss of a temporary tempfile:-------------------------->[ 6]"
echo -e "\e[31m\t\t\tLoss of a SYSTEM datafile:----------------------------->[ 7]"
echo -e "\e[30m\t\t\tLoss of an UNDO datafile:------------------------------>[ 8]"
echo -e "\e[31m\t\t\tLoss of a Read-Only tablespace:------------------------>[ 9]"
echo -e "\e[30m\t\t\tLoss of an Index tablespace:--------------------------->[10]"
echo -e "\e[31m\t\t\tLoss of all Non-unique/primary key indexes in USERS:--->[11]"
echo -e "\e[30m\t\t\tLoss of a non-system tablespace:----------------------->[12]" 
echo -e "\e[31m\t\t\tLoss of a temporary tablespace:------------------------>[13]" 
echo -e "\e[30m\t\t\tLoss of a SYSTEM tablespace:--------------------------->[14]"
echo -e "\e[31m\t\t\tLoss of an UNDO tablespace:---------------------------->[15]"
echo -e "\e[30m\t\t\tLoss of the password file:----------------------------->[16]"
echo -e "\e[31m\t\t\tLoss of all datafiles:--------------------------------->[17]" 
echo -e "\e[30m\t\t\tLoss of redo log member of a multiplexed group:-------->[18]" 
echo -e "\e[31m\t\t\tLoss of all redo log members of INACTIVE groups:------->[19]" 
echo -e "\e[30m\t\t\tLoss of all redo log members of an ACTIVE group:------->[20]" 
echo -e "\e[31m\t\t\tLoss of all redo log members of CURRENT group:--------->[21]" 
echo -e "\e[30m\t\t\tFile Header Corruption:-------------------------------->[22]"  
echo -e "\e[31m\t\t\tControl Files Corruption:------------------------------>[23]"  
echo -e "\e[30m\t\t\tCurrent Log File Corruption:--------------------------->[24]"  
echo -e "\e[31m\t\t\tLoss of all RMAN Backups:------------------------------>[25]"  
echo -e "\e[30m\t\t\tLoss of SPFILE:---------------------------------------->[26]"  
echo -e "\e[31m\t\t\tLoss of TNSNAMES and LISTENER:------------------------->[27]"  
echo -e "\e[30m\t\t\tLoss of ORACLE HOME:----------------------------------->[28]"  
echo -e "\e[31m\t\t\tLoss of FRA:------------------------------------------->[29]"  
echo 
echo -e "\e[30m\t\t\tReview all available PDB and ASM Crash Scenarios:\t[88]"
echo 
echo -e "\e[30m\t\t\tPerform a random CDB, PDB, or ASM Crash Scenario:\t[99]"
echo 
echo -e "\e[30m\t\t\tExit:\t\t\t\t\t\t\t[ 0]"
echo 
echo $ERRMSG
...
echo
echo
echo -e "\e[30m\tCrashSimulator - Oracle on Linux Crash Scenario Generator V1.03"
echo -e "\e[30m\t-----------------------------------------------------------------"
echo -e "\e[30m\tBy Francisco Munoz Alvarez - http://oraclenz.com"
echo -e "\e[30m\tFollow me on Twitter [FCOMUNOZ] or Linkedin for news about updates, tips and tricks using CrashSimulator"
echo
echo -e "\e[30m\t\tChoose one of the following scenarios:"
echo
echo -e "\e[30m\t\t\tPDB  scenarios:\t\t\t\t\t" 
echo -e "\e[30m\t\t\t---------------\t\t\t\t\t"
echo
echo -e "\e[31m\t\t\tLoss of a non-system datafile:------------------------->[30]" 
echo -e "\e[30m\t\t\tLoss of a temporary tempfile:-------------------------->[31]"
echo -e "\e[31m\t\t\tLoss of a SYSTEM datafile:----------------------------->[32]"
echo -e "\e[30m\t\t\tLoss of an UNDO datafile:------------------------------>[33]"
echo -e "\e[31m\t\t\tLoss of a Read-Only tablespace:------------------------>[34]"
echo -e "\e[30m\t\t\tLoss of an Index tablespace:--------------------------->[35]"
echo -e "\e[31m\t\t\tLoss of all Non-unique/primary key indexes in USERS:--->[36]"
echo -e "\e[30m\t\t\tLoss of a non-system tablespace:----------------------->[37]"
echo -e "\e[31m\t\t\tLoss of a temporary tablespace:------------------------>[38]"
echo -e "\e[30m\t\t\tLoss of a SYSTEM tablespace:--------------------------->[39]"
echo -e "\e[31m\t\t\tLoss of an UNDO tablespace:---------------------------->[40]"
echo -e "\e[30m\t\t\tLoss of all datafiles:--------------------------------->[41]"
echo -e "\e[31m\t\t\tPhysical Block Corruption:----------------------------->[42]"
echo -e "\e[30m\t\t\tLoss of a Table:--------------------------------------->[43]"
echo -e "\e[31m\t\t\tLoss of a Schema:-------------------------------------->[44]"
echo -e "\e[30m\t\t\tLoss of a PDB:----------------------------------------->[45]"
echo
echo -e "\e[30m\t\t\tASM senarios (Coming Soon):"
echo -e "\e[30m\t\t\t---------------------------"
echo
echo -e "\e[30m\t\t\tLoss of a data disk group:\t\t\t\t[46]"
echo -e "\e[30m\t\t\tLoss of OCR:\t\t\t\t\t\t[47]"
echo -e "\e[30m\t\t\tLoss of Voting Disk:\t\t\t\t\t[48]"
echo -e "\e[30m\t\t\taLoss of a ASM Spfile:\t\t\t\t\t[49]"
echo
echo -e "\e[30m\t\t\tBack to CDB scenarios:\t\t\t\t\t[77]"
echo
echo -e "\e[30m\t\t\tPerform a random CDB, PDB, or ASM Crash Scenario:\t[99]"
echo
echo -e "\e[30m\t\t\tExit:\t\t\t\t\t\t\t[ 0]"
