...
echo 
echo 
echo -e "\e[30m\t\t\tCDB  scenarios:\t\t\t\t\t" "\t\t\t\tPDB  scenarios:\t\t\t\t\t" "\t\t\t\tASM scenarios (Coming Soon):"
echo -e "\e[30m\t\t\t---------------\t\t\t\t\t" "\t\t\t\t---------------\t\t\t\t\t" "\t\t\t\t---------------------------"
echo 
echo 
echo -e "\e[31m\t\t\tLoss of a control file:-------------------------------->[ 1]" "\e[30m\t\t\tLoss of a non-system datafile:------------------------->[30]" "\e[30m\t\t\tLoss of a data disk group:\t\t\t[46]"
echo -e "\e[30m\t\t\tLoss of all control files:----------------------------->[ 2]" "\e[31m\t\t\tLoss of a temporary datafile:-------------------------->[31]" "\e[30m\t\t\tLoss of OCR:\t\t\t\t\t[47]"
echo -e "\e[31m\t\t\tLoss of a redo log file group member:------------------>[ 3]" "\e[30m\t\t\tLoss of a SYSTEM datafile:----------------------------->[32]" "\e[30m\t\t\tLoss of Voting Disk:\t\t\t\t[48]"
echo -e "\e[30m\t\t\tLoss of a redo log file group:------------------------->[ 4]" "\e[31m\t\t\tLoss of an UNDO datafile:------------------------------>[33]" "\e[30m\t\t\tLoss of a ASM Spfile:\t\t\t\t[49]"
echo -e "\e[31m\t\t\tLoss of a non-system datafile:------------------------->[ 5]" "\e[30m\t\t\tLoss of a Read-Only tablespace:------------------------>[34]"
echo -e "\e[30m\t\t\tLoss of a temporary tempfile:-------------------------->[ 6]" "\e[31m\t\t\tLoss of an Index tablespace:--------------------------->[35]"
echo -e "\e[31m\t\t\tLoss of a SYSTEM datafile:----------------------------->[ 7]" "\e[30m\t\t\tLoss of all Non-unique/primary key indexes in USERS:--->[36]"
echo -e "\e[30m\t\t\tLoss of an UNDO datafile:------------------------------>[ 8]" "\e[31m\t\t\tLoss of a non-system tablespace:----------------------->[37]"
echo -e "\e[31m\t\t\tLoss of a Read-Only tablespace:------------------------>[ 9]" "\e[30m\t\t\tLoss of a temporary tablespace:------------------------>[38]"
echo -e "\e[30m\t\t\tLoss of an Index tablespace:--------------------------->[10]" "\e[31m\t\t\tLoss of a SYSTEM tablespace:--------------------------->[39]"
echo -e "\e[31m\t\t\tLoss of all Non-unique/primary key indexes in USERS:--->[11]" "\e[30m\t\t\tLoss of an UNDO tablespace:---------------------------->[40]"
echo -e "\e[30m\t\t\tLoss of a non-system tablespace:----------------------->[12]" "\e[31m\t\t\tLoss of all datafiles:--------------------------------->[41]" 
echo -e "\e[31m\t\t\tLoss of a temporary tablespace:------------------------>[13]" "\e[30m\t\t\tPhysical Block Corruption:----------------------------->[42]"
echo -e "\e[30m\t\t\tLoss of a SYSTEM tablespace:--------------------------->[14]" "\e[31m\t\t\tLoss of a Table:--------------------------------------->[43]"
echo -e "\e[31m\t\t\tLoss of an UNDO tablespace:---------------------------->[15]" "\e[30m\t\t\tLoss of a Schema:-------------------------------------->[44]"
echo -e "\e[30m\t\t\tLoss of the password file:----------------------------->[16]" "\e[31m\t\t\tLoss of a PDB:----------------------------------------->[45]"
...
menu_id_28()
{
        ...
        # Counting the number of spfile foun"
