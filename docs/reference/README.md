...
- `autonomous_database_readiness_report_example.md`
  ...
  - HTML copy: `autonomous_database_readiness_report_example.md.html`
  - Raw evidence copy: `autonomous_database_readiness_report_example.evidence`
