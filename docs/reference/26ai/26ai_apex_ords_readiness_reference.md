...
CSIM_APEX|db_unique_name|exampledb
CSIM_APEX|db_role|PRIMARY
CSIM_APEX|open_mode|READ WRITE
CSIM_APEX|cdb|YES
CSIM_APEX|instance_name|exampledb1
CSIM_APEX|host_name|exampledb1
...
db.hostname                          example-scan.subexample.examplevcn.orac   Pool       
                                     levcn.com                                                       
