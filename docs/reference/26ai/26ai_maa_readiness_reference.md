...
- Raw SQL evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_maa_report_20260607_031506.evidence`
...
| Backup | Recent successful jobs 7d `1`, failed jobs 7d `0`, last success `2026-06-07 03:14:45`, datafiles without backup metadata `0`, devices `SBT_TAPE` |
...
| Storage/config | Control files `2`, redo min members `2`, redo groups with <2 members `0`, FRA configured `YES`, FRA used `.15%` |
...
| `OK` | File redundancy | Control file and redo multiplexing | control_files=2, redo_min_members=2 | Keep members separated across failure domains where possible. |
...
Evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_maa_report_20260607_031506.evidence`
...
CSIM_MAA|fra_used_pct|.15
CSIM_MAA|fra_reclaimable_pct|.14
CSIM_MAA|recent_successful_backup_jobs_7d|1
CSIM_MAA|recent_failed_backup_jobs_7d|0
CSIM_MAA|last_successful_backup_time|2026-06-07 03:14:45
CSIM_MAA|last_successful_backup_age_hours|0
...
Command: bash -lc srvctl\ config\ database\ -d\ \'crashdb_26ai\'\ 2\>\&1\;\ srvctl\ status\ database\ -d\ \'crashdb_26ai\'\ 2\>\&1\;\ srvctl\ config\ service\ -d\ \'crashdb_26ai\'\ 2\>\&1\;\ srvctl\ status\ service\ -d\ \'crashdb_26ai\'\ 2\>\&1
