...
- Generated UTC: `2026-06-15T10:38:41Z`
...
- RMAN repository source requested: `recovery catalog plus target control file`
- RMAN catalog connect: `RMAN_CATALOG/<redacted>@//10.0.0.216:1521/crashdb_CRASHPDB.paas.oracle.com`
- SQL evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_backup_report_20260615_103836.evidence`
...
| Level 0/full cadence | roughly hourly or better; last backup `2026-06-15 08:27:55`, age `2.2` hours |
| Level 1 incremental cadence | not enough history; last backup `NONE`, age `UNKNOWN` hours |
| Archived redo backup cadence | roughly hourly or better; last backup `2026-06-15 08:27:44`, age `2.2` hours |
| Visible database size | `13.48` GB across `17` datafiles |
| Backup device types | `DISK` |
| Backup piece device types | `DISK` |
| Backup-only RPO estimate | Backup-only RPO is approximately the age of the latest archived redo backup, currently about 2.2 hours; actual data loss can be lower if required archived logs and online redo survive locally. |
| Backup/recovery RTO estimate | Potential RTO may be lower if image copies are current and switch-to-copy/roll-forward is practiced. Visible database size is 13.48 GB. Latest Level 0/full backup age is 2.2 hours. Recent successful backup job duration averages 2.5 minutes and maxes at 2.7 minutes; restore time can differ and must be measured. |
...
| `OK` | Baseline | Recent Level 0/full backup | age_hours=2.2 | Keep Level 0/full backups aligned with restore-time objectives. |
| `OK` | Recoverability | ARCHIVELOG mode | log_mode=ARCHIVELOG | Continue backing archived redo frequently enough to meet RPO. |
| `OK` | RPO | Recent archived redo backup | age_hours=2.2 | Back up archived redo more frequently than the required backup-only RPO. |
...
- Backup repository source: `Recovery catalog requested; RMAN output below confirms whether it connected successfully.`.
- RTO guidance: Potential RTO may be lower if image copies are current and switch-to-copy/roll-forward is practiced. Visible database size is 13.48 GB. Latest Level 0/full backup age is 2.2 hours. Recent successful backup job duration averages 2.5 minutes and maxes at 2.7 minutes; restore time can differ and must be measured.
- RPO guidance: Backup-only RPO is approximately the age of the latest archived redo backup, currently about 2.2 hours; actual data loss can be lower if required archived logs and online redo survive locally.
...
Command: /u02/app/oracle/product/23.0.0.0/dbhome_1/bin/sqlplus -s /\ as\ sysdba @/tmp/crashsimulator/crashsimulator_logs/crashsim_backup_report_20260615_103836_detail.sql
...
Repository source requested: `recovery catalog plus target control file`

Command: `rman target / cmdfile=/tmp/crashsimulator.20260615_103836.rCMrWh/crashsim_backup_report_20260615_103836_repository.rman log=/tmp/crashsimulator/crashsimulator_logs/crashsim_backup_report_20260615_103836_repository.log`

```text

Recovery Manager: Release 23.26.2.0.0 - Production on Mon Jun 15 10:38:44 2026
Version 23.26.2.0.0
...
4> list backup of database summary;
5> list backup of archivelog all summary;
6> list expired backup summary;
7> list expired archivelog all;
8> report schema;
9> report need backup;
10> report obsolete;
...
------- -- -- - ----------- --------------- ------- ------- ---------- ---
187     B  F  A DISK        15-JUN-26       1       1       NO         TAG20260615T063711
188     B  F  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615073817
189     B  F  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615073817
190     B  F  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615073817
191     B  F  A DISK        15-JUN-26       1       1       NO         TAG20260615T074019
192     B  A  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615073817_ARCH
193     B  F  A DISK        15-JUN-26       1       1       NO         CSIM_BASE_260615073817_CTL
194     B  F  A DISK        15-JUN-26       1       1       NO         CSIM_BASE_260615073817_SPFILE
195     B  F  A DISK        15-JUN-26       1       1       NO         TAG20260615T074059
196     B  F  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615082525
197     B  F  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615082525
198     B  F  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615082525
199     B  F  A DISK        15-JUN-26       1       1       NO         TAG20260615T082726
200     B  A  A DISK        15-JUN-26       1       1       YES        CSIM_BASE_260615082525_ARCH
201     B  F  A DISK        15-JUN-26       1       1       NO         CSIM_BASE_260615082525_CTL
202     B  F  A DISK        15-JUN-26       1       1       NO         CSIM_BASE_260615082525_SPFILE
203     B  F  A DISK        15-JUN-26       1       1       NO         TAG20260615T082752
...
-------------------- ------ ------------------ --------------------
Backup Set           187    15-JUN-26         
  Backup Piece       204    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/AUTOBACKUP/2026_06_15/s_1235975831.OMF.012BC195
Backup Set           188    15-JUN-26         
  Backup Piece       205    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/BACKUPSET/2026_06_15/nnndf0_CSIM_BASE_260615073817_0.OMF.5E326159
Backup Set           189    15-JUN-26         
  Backup Piece       206    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/5445D83CA62AD33EE0630500000AB777/BACKUPSET/2026_06_15/nnndf0_CSIM_BASE_260615073817_0.OMF.10BE2406
Backup Set           190    15-JUN-26         
  Backup Piece       207    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/5445B43E3238B3BCE0630500000A274A/BACKUPSET/2026_06_15/nnndf0_CSIM_BASE_260615073817_0.OMF.02C4622F
Backup Set           191    15-JUN-26         
  Backup Piece       208    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/AUTOBACKUP/2026_06_15/s_1235979619.OMF.2F36F593
Backup Set           193    15-JUN-26         
  Backup Piece       210    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/BACKUPSET/2026_06_15/ncnnf0_CSIM_BASE_260615073817_CTL_0.OMF.3C244ED6
Backup Set           194    15-JUN-26         
  Backup Piece       211    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/BACKUPSET/2026_06_15/nnsnf0_CSIM_BASE_260615073817_SPFILE_0.OMF.475DF89E
Backup Set           195    15-JUN-26         
  Backup Piece       212    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/AUTOBACKUP/2026_06_15/s_1235979659.OMF.4B00A687
Backup Set           199    15-JUN-26         
  Backup Piece       216    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/AUTOBACKUP/2026_06_15/s_1235982446.OMF.0D3AA8DC
Backup Set           201    15-JUN-26         
  Backup Piece       218    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/BACKUPSET/2026_06_15/ncnnf0_CSIM_BASE_260615082525_CTL_0.OMF.21B58463
Backup Set           202    15-JUN-26         
  Backup Piece       219    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/BACKUPSET/2026_06_15/nnsnf0_CSIM_BASE_260615082525_SPFILE_0.OMF.2EF16019
Control File Copy     292    15-JUN-26          @gB2Ac2II/CRASHRAC-5FB9415B042BDF9DBF8F840EF0BDF92F/CRASHRAC/CONTROLFILE/crashsim_control02_20260615_081819.ctl

Starting restore at 15-JUN-26
allocated channel: ORA_DISK_1
channel ORA_DISK_1: SID=2414 instance=crashdb1 device type=DISK
...
Evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_backup_report_20260615_103836.evidence`
...
CSIM_BKP|last_datafile_backup_age_hours|2.2
CSIM_BKP|last_level0_backup_time|2026-06-15 08:27:55
CSIM_BKP|last_level0_backup_age_hours|2.2
...
CSIM_BKP|last_successful_job_age_hours|2.2
...
CSIM_BKP|last_archivelog_backup_age_hours|2.2
...
CSIM_BKP|last_controlfile_backup_age_hours|2.2
