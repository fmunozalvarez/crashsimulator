...
- Generated UTC: `2026-06-15T08:50:03Z`
...
- Raw SQL evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_maa_report_20260615_085001.evidence`
- Data Guard Broker FSFO evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_maa_report_20260615_085001_dgmgrl_fsfo.out`
...
| Backup | Recent successful jobs 7d `2`, failed jobs 7d `0`, last success `2026-06-15 08:27:55`, datafiles without backup metadata `0`, devices `DISK` |
...
| Storage/config | Control files `1`, redo min members `2`, redo groups with <2 members `0`, FRA configured `YES`, FRA used `4.34%` |
...
| `OK` | Backup | Recent complete RMAN backup coverage | jobs_7d=2, no_backup_files=0 | Continue scheduled restore preview/validate drills and retain off-host copies. |
...
Evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_maa_report_20260615_085001.evidence`
...
File: `/tmp/crashsimulator/crashsimulator_logs/crashsim_maa_report_20260615_085001_dgmgrl_fsfo.out`
