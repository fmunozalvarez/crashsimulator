...
- SQL evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_resilience_scorecard_20260615_092406.evidence`
...
| Application Continuity | `40/100 (At Risk)` | `8%` | score=2/5, AC=0, TAC=0, role_services=UNKNOWN, APEX/session_drill=no | Validate client pools, FAN/ONS, AC/TAC replay safety, role-based services, and APEX/ORDS session behavior where applicable. |

## Overall Score

| Metric | Value |
| --- | --- |
| Resilience Score | `54/100 (At Risk)` |
| Total weight | `100` |
...
- MAA SQL evidence: `/tmp/crashsimulator/crashsimulator_logs/crashsim_resilience_scorecard_20260615_092406.evidence`
- srvctl service evidence: `/tmp/crashsimulator/crashsimulator_logs/crashsim_resilience_scorecard_20260615_092406_srvctl_services.out`
- DGMGRL/FSFO evidence: `/tmp/crashsimulator/crashsimulator_logs/crashsim_resilience_scorecard_20260615_092406_dgmgrl_fsfo.out`
