...
- Generated UTC: `2026-06-15T11:31:31Z`
...
- SQL evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_apex_ords_report_20260615_113127.evidence`
...
| Signal | Value |
| --- | --- |
| ORDS binary | `not found` |
| ORDS version | `not found` |
...
| --- | --- | --- | --- | --- |
| `GAP` | ORDS host | ORDS binary available | ords=not found | Install ORDS on every intended mid-tier node before ORDS outage drills. |
...
Evidence file: `/tmp/crashsimulator/crashsimulator_logs/crashsim_apex_ords_report_20260615_113127.evidence`
...
● ords.service - Oracle REST Data Services for CrashSimulator APEX lab
   ...
   Active: active (running) since Mon 2026-06-15 11:27:43 UTC; 3min 51s ago
 Main PID: 301682 (java)
    Tasks: 53 (limit: 137245)
   Memory: 768.5M
