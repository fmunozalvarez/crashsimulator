...
- Generated UTC: `2026-06-15T07:30:37Z`
...
| PLAN-ONLY | 43 | Scenario can produce useful dry-run/runbook evidence, but execution is blocked by a guardrail or provider-specific limitation. |
| NOT-RUNNABLE | 26 | Scenario is not available in the current topology or target context. |
...
| `16` | Config | CDB/non-CDB | destructive | Loss of password file | Password file path was not discovered. |
